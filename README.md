...
**Local Vite + backends (prepare monolith → LocalStack → AWS):** **[local-e2e-userguide.md](./local-e2e-userguide.md)** (switching **`VITE_API_BASE_URL`**, **[spa/.env.example](./spa/.env.example)**).
